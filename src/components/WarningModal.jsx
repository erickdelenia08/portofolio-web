...
const WarningModal = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-scnd-col bg-opacity-50 flex justify-center items-center z-50 backdrop-blur-sm font-montserrat">
      <div className="bg-gray-col p-6 rounded-lg shadow-lg sm:max-w-sm text-center select-none w-3/4">
        <div className="text-xs sm:text-base">
          <h2 className="text-base sm:text-xl font-semibold mb-4">Welcome!</h2>
