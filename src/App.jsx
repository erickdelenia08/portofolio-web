...
function App() {
  ...
  return (
    <div className="">
      ...
      <div className="bg-main-col overflow-hidden">
        ...
        <div className="px-5 sm:px-40 font-montserrat text-white-col flex flex-col gap-4">
          ...
          <span className="text-justify sm:text-2xl text-lg">Graduated from S1 Mathematics University of Jember (2019-2023) with a passion to continue learning and developing in the world of technology. Currently, I am exploring web development using React and mobile development with Flutter. Not only that, I also have expertise in creating creative animations using Adobe After Effects and Illustrator. Want to know more about my skills, achievements, and experiences? Let's scroll down!</span>
        </div>
